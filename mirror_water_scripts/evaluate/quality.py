...
from engine.mirror_water.geometry import MirrorAxis
from engine.mirror_water.geometry import reconstruct_geometry_from_points as _mw_reconstruct_geometry_from_points
...
def mirror_water_solvability_check(
    original_points,
    axis: MirrorAxis,
    axis_offset: float,
    expected_answer_points,
) -> bool:
    rebuilt = _mw_reconstruct_geometry_from_points(original_points, axis, axis_offset)
